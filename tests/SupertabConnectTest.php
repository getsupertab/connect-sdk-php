...
final class SupertabConnectTest extends TestCase
{
    ...
    public function test_handle_request_soft_mode_signals_when_no_token(): void
    {
        $stc = new SupertabConnect(
            apiKey: 'test-key',
    ...
    public function test_handle_request_strict_mode_blocks_when_no_token(): void
    {
        $stc = new SupertabConnect(
            apiKey: 'test-key',
    ...
    public function test_handle_request_ignores_non_license_auth_header(): void
    {
        $stc = new SupertabConnect(
            apiKey: 'test-key',
            enforcement: EnforcementMode::SOFT,
        ...
        // Non-"License " prefix is treated as no token
        $result = $stc->handleRequest($context);
