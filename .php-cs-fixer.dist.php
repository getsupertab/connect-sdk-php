...
return (new PhpCsFixer\Config())
    ...
    ->setRules([
        ...
        'fully_qualified_strict_types' => [
            'import_symbols' => true,
            'phpdoc_tags' => [
                'param', 'phpstan-param', 'phpstan-property', 'phpstan-property-read',
                'phpstan-property-write', 'phpstan-return', 'phpstan-var', 'property',
                'property-read', 'property-write', 'psalm-param', 'psalm-property',
                'psalm-property-read', 'psalm-property-write', 'psalm-return', 'psalm-var',
                'return', 'see', 'throws', 'var', 'extends', 'implements', 'use',
                'phpstan-extends', 'phpstan-implements', 'phpstan-use', 'psalm-extends',
                'psalm-implements', 'psalm-use', 'mixin', 'param-out', 'param-closure-this',
                'phpstan-param-out', 'phpstan-assert', 'phpstan-assert-if-true',
                'phpstan-assert-if-false', 'phpstan-self-out', 'phpstan-this-out',
